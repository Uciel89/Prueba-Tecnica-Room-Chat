...
Esta es una pequeña aplicación mobile para el sistema Android, en la cual podemos enviar mensajes e interactuar con otros usuarios en un espacio en común, en esta primera versión solo se puede enviar mensajes de texto.  
